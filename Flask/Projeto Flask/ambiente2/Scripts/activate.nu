...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Gamer - PC\Documents\Códigos\Flask\Projeto Flask\ambiente2'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Gamer - PC\Documents\Códigos\Flask\Projeto Flask\ambiente2\Scripts\deactivate.nu'
